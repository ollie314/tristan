...
/**
  * This is an event sourced entity. It has a state, [[ContractsState]], which
  ...
  */
class ContractsEntity extends PersistentEntity {
  ...
  /**
    ...
    */
  override def initialState: ContractsState = ContractsState("Contract is on the way", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case ContractsState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        ContractsState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class ContractsState(message: String, timestamp: String)
...
object ContractsState {
  /**
    ...
    */
  implicit val format: Format[ContractsState] = Json.format
}

/**
  * This interface defines all the events that the ContractsEntity supports.
  */
sealed trait ContractsEvent extends AggregateEvent[ContractsEvent] {
  def aggregateTag = ContractsEvent.Tag
}

object ContractsEvent {
  val Tag = AggregateEventTag[ContractsEvent]
}

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends ContractsEvent
...
/**
  ...
  */
sealed trait ContractsCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends ContractsCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends ContractsCommand[String]
...
/**
  ...
  * application loader.
  */
object ContractsSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[ContractsState]
  )
}
